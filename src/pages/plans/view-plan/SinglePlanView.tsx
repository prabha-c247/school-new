...
const SinglePlanView = () => {
  ...
  const plan: Plan | undefined = useSelector((state: RootState) =>
    state.plan.Plans.find((plan) => plan._id === id)
  );
                ...
                <Container>
                  <Row className="m-4 ">
                    <Col md={6} className="text">
                      Plan Name:{" "}
                      <p className={styles.customColor}>{plan.planName}</p>
                    </Col>
                    <Col md={6}>
                      Pricing:{" "}
                      <p className={styles.customColor}>{plan.pricing}</p>
                    </Col>
                  </Row>
                  <Row className="m-4">
                    <Col md={6}>
                      Plan Duration:{" "}
                      <p className={styles.customColor}>{plan.duration}</p>
                    </Col>
                    <Col md={6}>
                      Plan Usage Limits:{" "}
                      <p className={styles.customColor}>{plan.usageLimit}</p>
                    </Col>
                  </Row>
                  <Row className="m-4">
                    <Col>
                      Features:
                      <p className={styles.customColor}>{plan.features}</p>{" "}
                    </Col>
                  </Row>
                  <Row className="m-4">
                    <Col md={6}>
                      Trial Period Limit:{" "}
                      <p className={styles.customColor}>{plan.trialPeriod}</p>
                    </Col>
                    <Col md={6}>
                      Billing Cycle:{" "}
                      <p className={styles.customColor}>{plan.billingCycle}</p>
                    </Col>
                  </Row>
                  <Row className="m-4">
                    <Col md={6}>
